...
CREATE TABLE "user_settings" (
	...
	"revision_enabled" boolean DEFAULT true NOT NULL,
...
ALTER TABLE "revision_history" ADD CONSTRAINT "revision_history_user_id_users_id_fk" FOREIGN KEY ("user_id") REFERENCES "public"."users"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "revision_queue" ADD CONSTRAINT "revision_queue_user_id_users_id_fk" FOREIGN KEY ("user_id") REFERENCES "public"."users"("id") ON DELETE cascade ON UPDATE no action;